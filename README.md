...
The following is a photo of my Graphic display working. It reads an analog value from A0 where the Photo Cell is connected and then prints out the value.
![](Images/G_Display.jpg)


The following is my code for the Grpahic Display:
```
/**************************************************************************
